...
7. If a project is using a different `git` command or an alias for it such as `dotfiles` or is in a scope of such alias, **ALWAYS** use that command or alias instead of `git`.
